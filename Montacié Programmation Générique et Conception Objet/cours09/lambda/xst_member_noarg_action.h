 ...
 * @brief Defines implementation class for closure of member function with no arguments.
 *
 * @warning
...
// xst_member_noarg_action.h

#ifndef _XST_MEMBER_NOARG_ACTION_H_INCLUDED_
#define _XST_MEMBER_NOARG_ACTION_H_INCLUDED_

namespace cttl_impl {

/**@class xst_member_action
* @brief Implements closure object for member function with no arguments.
*
* @tparam ObjectT
...
class xst_member_action< ObjectT, MemberActionT, /*ArgumentT*/void, ResultT >
...
public:
    ...
    typedef xst_member_action< ObjectT, MemberActionT, /*ArgumentT*/void, ResultT > action_T;
...
#ifdef CTTL_TRACE_DEPOSITS
        trace_prolog();
        result_T result = m_member_action( &m_object.value() );
        trace_epilog( result );
        return result;
#else
        return m_member_action( &m_object.value() );
#endif // CTTL_TRACE_DEPOSITS
    }
...
#endif //_XST_MEMBER_NOARG_ACTION_H_INCLUDED_
