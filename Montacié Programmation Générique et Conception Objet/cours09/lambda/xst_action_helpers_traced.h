 ...
 * @brief Defines helper functions to instantiate CTTL traceable closure objects.
 *
 * @warning
...
#ifndef _XST_ACTION_HELPERS_TRACED_H_INCLUDED_
#define _XST_ACTION_HELPERS_TRACED_H_INCLUDED_

#ifdef CTTL_TRACE_DEPOSITS
#   define CTTL_MEMBER_ACTION( xobject, xaction, xargument ) cttl_impl::xst_traced_action( __LINE__, CTTL_QUOTED_EXPRESSION( xaction ), xobject, xaction, xargument )
#   define CTTL_MEMBER_ACTION_NOARG( xobject, xaction ) cttl_impl::xst_traced_action( __LINE__, CTTL_QUOTED_EXPRESSION( xaction ), xobject, xaction )
#   define CTTL_STATIC_ACTION( xaction, xargument ) cttl_impl::xst_traced_action( __LINE__, CTTL_QUOTED_EXPRESSION( xaction ), xaction, xargument )
#   define CTTL_STATIC_ACTION_NOARG( xreseulttype, xaction ) cttl_impl::xst_traced_action< xreseulttype >( __LINE__, CTTL_QUOTED_EXPRESSION( xaction ), xaction )
#else
...
#endif //_XST_ACTION_HELPERS_TRACED_H_INCLUDED_
