 ...
 * @brief Defines implementation class for closure of void member function.
 *
 * @warning
...
#ifndef _XST_MEMBER_VOID_H_INCLUDED_
#define _XST_MEMBER_VOID_H_INCLUDED_

namespace cttl_impl {

/**@class xst_member_action
* @brief Partial specialization for closure object for @c void member function with one argument.
*
* @tparam ObjectT
...
class xst_member_action< ObjectT, MemberActionT, ArgumentT, /*ResultT*/void >
...
public:
    ...
    typedef xst_member_action< ObjectT, MemberActionT, ArgumentT, /*ResultT*/void > action_T;
    ...
    result_T operator* () const
    {
        ...
        m_member_action( &m_object.value(), m_argument.value() );
...
#endif //_XST_MEMBER_VOID_H_INCLUDED_
