...
#ifndef _XST_STATIC_VOID_H_INCLUDED_
#define _XST_STATIC_VOID_H_INCLUDED_

namespace cttl_impl {

/**@class xst_static_action
* @brief Implements closure object for void function with one argument.
*
...
class xst_static_action< StaticActionT, ArgumentT, /*ResultT*/void >
...
public:
    ...
    typedef xst_static_action< StaticActionT, ArgumentT, /*ResultT*/void > action_T;
    ...
    result_T operator* () const
    {
        ...
        m_static_action( m_argument.value() );
...
#endif //_XST_STATIC_VOID_H_INCLUDED_
