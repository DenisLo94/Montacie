...
// xst_static_noarg_action.h

#ifndef _XST_STATIC_NOARG_ACTION_H_INCLUDED_
#define _XST_STATIC_NOARG_ACTION_H_INCLUDED_

namespace cttl_impl {

/**@class xst_static_action
* @brief Implements partial specialization for closure object for function with no arguments.
*
...
class xst_static_action< StaticActionT, /*ArgumentT*/void, ResultT >
...
#ifdef CTTL_TRACE_DEPOSITS
        trace_prolog();
        result_T result = m_static_action();
        trace_epilog( result );
        return result;
#else
        return m_static_action();
#endif // CTTL_TRACE_DEPOSITS
    }
...
#endif //_XST_STATIC_NOARG_ACTION_H_INCLUDED_
